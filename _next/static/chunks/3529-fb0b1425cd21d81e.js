  ...
  [3529],
  {
    5235: (e) => {
      e.exports = {
        ...
        className: "__className_ef116d",
        variable: "__variable_ef116d",
      };
    },
    12316: (e, t, a) => {
      "use strict";
      ...
      class u {
        static createSnowflakes(e, t, a) {
          if (!e) return [];
          let r = [];
          for (let n = 0; n < t; n++) r.push(new u(e, a));
          return r;
        }
        constructor(e, t = {}) {
          this.updateConfig(t);
        ...
        updateConfig(e) {
          let t = this.config;
          (this.config = { ...l, ...e }),
            (this.config.changeFrequency = o(
              this.config.changeFrequency,
              1.5 * this.config.changeFrequency
            )),
            this.params &&
              !s(this.config.radius, null == t ? void 0 : t.radius) &&
              (this.params.radius = o(...this.config.radius)),
            s(this.config.images, null == t ? void 0 : t.images) ||
              this.selectImage(),
            (null == t ? void 0 : t.opacity) &&
              !s(this.config.opacity, null == t ? void 0 : t.opacity) &&
              (this.params.hasNextOpacity = !0);
        }
        updateTargetParams() {
          (this.params.nextSpeed = o(...this.config.speed)),
            (this.params.nextWind = o(...this.config.wind)),
            this.image &&
              (this.params.nextRotationSpeed = o(...this.config.rotationSpeed));
        }
        update(e, t, a = 1) {
          let {
            x: r,
          ...
          (this.params.x = (r + f * a) % (e + 2 * d)),
            this.params.x > e + d && (this.params.x = -d),
            (this.params.y = (n + l * a) % (t + 2 * d)),
            this.params.y > t + d &&
              (this.params.hasNextOpacity &&
                ((this.params.opacity = o(...this.config.opacity)),
                (this.params.hasNextOpacity = !1)),
              (this.params.y = -d)),
            this.image && (this.params.rotation = (i + s) % 360),
            (this.params.speed = 0.99 * l + 0.01 * h),
            (this.params.wind = 0.99 * f + 0.01 * u),
            (this.params.rotationSpeed = 0.99 * s + 0.01 * c),
            this.framesSinceLastUpdate++ > this.config.changeFrequency &&
              (this.updateTargetParams(), (this.framesSinceLastUpdate = 0));
        }
        getImageOffscreenCanvas(e, t) {
          var a, r;
          if (e instanceof HTMLImageElement && e.loading) return e;
          let n = u.offscreenCanvases.get(e);
          if ((n || ((n = {}), u.offscreenCanvases.set(e, n)), !(t in n))) {
        ...
        drawCircle(e) {
          e.moveTo(this.params.x, this.params.y),
            e.arc(this.params.x, this.params.y, this.params.radius, 0, f);
        }
        drawImage(e) {
          let { x: t, y: a, rotation: r, radius: n } = this.params,
            i = (r * Math.PI) / 180,
            s = Math.cos(i),
            o = Math.sin(i);
          1 !== this.params.opacity &&
            (e.save(), (e.globalAlpha = this.params.opacity)),
            e.setTransform(s, o, -o, s, t, a);
          let c = this.getImageOffscreenCanvas(this.image, n);
          e.drawImage(c, -(n / 2), -(n / 2), n, n),
            1 !== this.params.opacity && e.restore();
        }
      }
      u.offscreenCanvases = new WeakMap();
      let h = {
          pointerEvents: "none",
      ...
      class g {
        ...
        set canvas(e) {
          m(this, n, e, "f"), m(this, r, e.getContext("2d"), "f");
        }
        constructor(e, t) {
          (this.lastUpdate = Date.now()),
            ...
            (this.config = { snowflakeCount: 150, ...l, ...t }),
            (this.snowflakes = []),
            (this.snowflakes = u.createSnowflakes(
              e,
              t.snowflakeCount || 150,
              t
            )),
            this.play();
        }
        updateConfig(e) {
          ...
          let t = this.config.snowflakeCount - this.snowflakes.length;
          for (let a of (t > 0 &&
            (this.snowflakes = [
              ...this.snowflakes,
              ...u.createSnowflakes(this.canvas, t, e),
            ]),
          t < 0 &&
            (this.snowflakes = this.snowflakes.slice(
              0,
              this.config.snowflakeCount
            )),
          this.snowflakes))
            a.updateConfig(this.config);
        }
        render(e = 1) {
          let { ctx: t, canvas: a, snowflakes: r } = this;
          if (!t || !a) return;
          let { offsetWidth: n, offsetHeight: i } = a;
          for (let t of r) t.update(n, i, e);
          if (
            (t.setTransform(1, 0, 0, 1, 0, 0),
            t.clearRect(0, 0, n, i),
            this.config.images && this.config.images.length > 0)
          ) {
            for (let e of r) e.drawImage(t);
            return;
          }
          for (let e of (t.beginPath(), r)) e.drawCircle(t);
          (t.fillStyle = this.config.color), t.fill();
        }
        loop() {
          let e = Date.now(),
            t = Date.now() - this.lastUpdate;
          (this.lastUpdate = e),
            this.render(t / d),
      ...
      let y = (e) => {
          let [t, a] = (0, i.useState)(c(e.current)),
            r = (0, i.useCallback)(() => {
              e.current && a(c(e.current));
            }, [e]);
          return (
            (0, i.useEffect)(() => {
          ...
          let d = w(h),
            ...
            v = (function (e) {
              ...
              return (
                !(function (e, t) {
                  let a = (0, i.useRef)(t);
                  s(t, a.current) || (a.current = t),
                    (0, i.useEffect)(e, a.current);
                })(() => a(e), [e]),
                t
              );
            })({
          ...
          return (
            (0, i.useEffect)(
              () => (
                !k.current &&
                  p.current &&
                  (k.current = new g(p.current, b.current)),
                () => {
                  var e;
                  null == (e = k.current) || e.pause(), (k.current = void 0);
                }
              ),
              []
            ),
        ...
        try {
          return (function e(i, s) {
            ...
            if (i && s && "object" == typeof i && "object" == typeof s) {
              ...
              if (Array.isArray(i)) {
                if ((o = i.length) != s.length) return !1;
                for (c = o; 0 != c--; ) if (!e(i[c], s[c])) return !1;
                return !0;
              }
              ...
              if (n && ArrayBuffer.isView(i) && ArrayBuffer.isView(s)) {
                if ((o = i.length) != s.length) return !1;
                for (c = o; 0 != c--; ) if (i[c] !== s[c]) return !1;
                return !0;
              }
              ...
              if ((o = (f = Object.keys(i)).length) !== Object.keys(s).length)
                return !1;
              for (c = o; 0 != c--; )
    ...
    77504: (e, t, a) => {
      ...
      function f() {
        return "development" === ((o() ? window.vam : c()) || "production");
      }
      function l(e) {
        return new RegExp(
          "/".concat(e.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "(?=[/?#]|$)")
        ...
        return (
          ...
          (0, r.useEffect)(() => {
            ...
            !(function () {
              ...
              if (document.head.querySelector('script[src*="'.concat(a, '"]')))
                return;
              ...
              basePath:
                null != (t = e.basePath)
                  ? t
                  : (function () {
                      if (void 0 !== i && void 0 !== i.env)
                        return i.env.REACT_APP_VERCEL_OBSERVABILITY_BASEPATH;
                    })(),
          ...
          (0, r.useEffect)(() => {
            e.route &&
              ...
              (function (e) {
                var t;
                let { route: a, path: r } = e;
                null == (t = window.va) ||
                  t.call(window, "pageview", { route: a, path: r });
      ...
      function d(e) {
        ...
        return r.createElement(u, {
          ...
          basePath: (function () {
            if (void 0 !== i && void 0 !== i.env)
              return i.env.NEXT_PUBLIC_VERCEL_OBSERVABILITY_BASEPATH;
          })(),
          framework: "next",
        });
      }
